...
interface TitleOptions {
  gl: WebGL2RenderingContext & { renderer: Renderer; canvas: HTMLCanvasElement };
  plane: Mesh;
  renderer: Renderer;
  text: string;
  textColor?: string;
...
class Title {
  private gl: WebGL2RenderingContext & { renderer: Renderer; canvas: HTMLCanvasElement };
  private plane: Mesh;
...
class App {
  ...
  private onCheckDebounce: (...args: unknown[]) => void;
